        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    ...
                    key = _c;
                    if (!(!object[key] || typeof object[key] !== 'object')) return [3 /*break*/, 2];
                ...
                case 3:
                    ...
                    return [3 /*break*/, 6];
                case 4:
                    _f = decryptedConfigObject;
                    _g = key;
                    return [4 /*yield*/, decryptConfigObject(object[key], encryptionKey)];
                case 5:
                    _f[_g] = _h.sent();
                    _h.label = 6;
                case 6:
...
function decryptConfigValue(text, encryptionKey, iv) {
    return __awaiter(this, void 0, void 0, function () {
        var decipher;
        return __generator(this, function (_a) {
            switch (_a.label) {
